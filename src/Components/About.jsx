...
const About = () => {
    return (
        <div>
            <div className="hero min-h-[70vh] bg-contain" style={{ backgroundImage: 'url("/Blackbelt.png")' }}>
            ...
            <section className='flex gap-5 flex-col md:flex-row m-14 lg:p-7'>
                ...
                <p className='text-lg text-blue-600 font-bold text-justify lg:p-5'>
